...
class BSM(object):
    ...
    def vol(self, target_price, max_iterations=200, precision=1.0e-5):
        q = 0.5
...
if __name__ == '__main__':
    ...
    print(BSM(asset_price=4815.226, exercise_price=4500, remaining=0.0877, call_put='C', rf_rate=0).vol(target_price=354.205))
